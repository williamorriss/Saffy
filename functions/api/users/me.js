...
function onRequestGet(context) {
    return __awaiter(this, void 0, void 0, function () {
        var env, token, secretKey, payload;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    env = context.env;
                    token = (0, typescript_cookie_1.getCookie)("auth_token");
                    if (!token) {
                        return [2 /*return*/, new Response("Cookie not found.", {
                                status: 404,
                                headers: {
                ...
                case 1:
                    ...
                    return [2 /*return*/, Response.json(payload)];
            }
        });
    });
}
